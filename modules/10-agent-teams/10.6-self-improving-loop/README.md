...
- **Скринкаст #3, крок 1 - live-only, не з кіту.** Крок 2 (баг `skill_md[:1500]`) детермінований. Але «суб'єктивний суддя завис на 6 з 10» - це число із зовнішнього Hermes-кейсу (див. Sources лекції), а не вихід цього кіту. У кіті є лише `eval/rubric.md` як ілюстрація суб'єктивного критерію; детермінованого стенд-іна на «6/10» немає навмисно - плато суб'єктивної оцінки треба показувати живим агентом або цитувати як кейс.
